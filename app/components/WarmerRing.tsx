...
export default function WarmerRing({ temperature, idle }: WarmerRingProps) {
  ...
  const color = idle ? "#000000" : "#ff6600";
    ...
    <group position={[0, -0.35, 0]} rotation={[-Math.PI / 2, 0, 0]}>
      ...
      <mesh>
        ...
        <meshStandardMaterial
          ...
          roughness={0.5}
          emissive="#ff3300"
          emissiveIntensity={idle ? 0 : 0.15 * heatRatio}
          transparent
          opacity={idle ? 0 : heatRatio * 0.7}
        />
      </mesh>
      ...
      <mesh>
        ...
        <meshStandardMaterial
          ...
          roughness={0.4}
          emissive="#ff3300"
          emissiveIntensity={idle ? 0 : 0.35 * heatRatio}
          transparent
          opacity={idle ? 0 : heatRatio}
        />
      </mesh>
      ...
      <mesh>
        ...
        <meshStandardMaterial
          ...
          roughness={0.6}
          emissive="#ff2200"
          emissiveIntensity={idle ? 0 : 0.12 * heatRatio}
          transparent
          opacity={idle ? 0 : heatRatio * 0.5}
        />
      </mesh>
    </group>
  );
